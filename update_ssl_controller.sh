...
if [ "${CONTROLLER_TARGET_DEVICE}" == "SELFHOST" ]; then
    CONTROLLER_SELFHOST_SSL_KEYSTORE=${CONTROLLER_SELFHOST_SSL_KEYSTORE}
    CONTROLLER_SELFHOST_SSL_KEY=${CONTROLLER_SELFHOST_SSL_KEY}
    CONTROLLER_SELFHOST_SSL_CRT=${CONTROLLER_SELFHOST_SSL_CRT}
    CONTROLLER_SELFHOST_SSL_PRE_DEPLOY_EXEC=${CONTROLLER_SELFHOST_SSL_PRE_DEPLOY_EXEC}
    CONTROLLER_SELFHOST_SSL_POST_DEPLOY_EXEC=${CONTROLLER_SELFHOST_SSL_POST_DEPLOY_EXEC}
elif [ "${CONTROLLER_TARGET_DEVICE}" == "DOCKER" ]; then
    CONTROLLER_DOCKER_SSL_KEYSTORE=${CONTROLLER_DOCKER_SSL_KEYSTORE}
    CONTROLLER_DOCKER_SSL_KEY=${CONTROLLER_DOCKER_SSL_KEY}
    CONTROLLER_DOCKER_SSL_CRT=${CONTROLLER_DOCKER_SSL_CRT}
    CONTROLLER_DOCKER_SSL_PRE_DEPLOY_EXEC=${CONTROLLER_DOCKER_SSL_PRE_DEPLOY_EXEC}
    CONTROLLER_DOCKER_SSL_POST_DEPLOY_EXEC=${CONTROLLER_DOCKER_SSL_POST_DEPLOY_EXEC}
else
